...
public class MajorDevelopment_List_Adapter extends RecyclerView.Adapter<MajorDevelopment_List_Adapter.ContactViewHolder> implements View.OnClickListener {

    private List<NewsAndEventsModel> newsList;
    Context context;

    public MajorDevelopment_List_Adapter(Context context, List<NewsAndEventsModel> cList) {
        this.newsList = cList;
...
//        contactViewHolder.tvNewsTime.setText(ci.news_date_np);
    ...
    public ContactViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.cardview_major_development_items, viewGroup, false);
