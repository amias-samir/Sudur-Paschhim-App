...
import com.naxa.nepal.sudurpaschimanchal.adapter.PolticianList_Adapter;
        ...
        protected String doInBackground(String... params) {
            ...
            if (sharedpreferences.getString("polticianjson", "").trim().isEmpty()) {
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    editor.putString("polticianjson", text);
                    editor.commit();
                } else {
                    try {
                        Snackbar.make(rootView, "ईन्टरनेट कनेक्सन छैन । ", Snackbar.LENGTH_LONG)
                ...
                text = sharedpreferences.getString("polticianjson", "");
            }
