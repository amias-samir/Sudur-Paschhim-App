...
public class IntroductionActivity extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener {
    ...
    GlideDrawable slider_1, slider_2, slider_3, slider_4, slider_5;
    String slider_1_desc, slider_2_desc, slider_3_desc, slider_4_desc, slider_5_desc;
...
//        getSupportActionBar().setDisplayShowTitleEnabled(false);
        ...
        try {
            ...
            url_maps.put("abc", "http://naxa.com.np/sudurapi/img/deve1.png");
            url_maps.put(slider_2_desc, "http://naxa.com.np/sudurapi/img/deve2.png");
            url_maps.put(slider_3_desc, "http://naxa.com.np/sudurapi/img/deve3.png");
            url_maps.put(slider_4_desc, "http://naxa.com.np/sudurapi/img/deve5.png");
//            url_maps.put(slider_5_desc, "http://naxa.com.np/sudurapi/img/deve5.png");
...
//            ((MainActivity) getActivity()).getSupportActionBar().setTitle("Introduction");
        //     ((MainActivity) getActivity()).getToolbar().setBackgroundResource(R.color.colorPrimary);
    }
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                for (int i = 0; i < data.length(); i++) {
                    ...
                    slider_1_desc = c.getString("img_1_desc");
                    slider_2_desc = c.getString("img_2_desc");
                    slider_3_desc = c.getString("img_3_desc");
                    slider_4_desc = c.getString("img_4_desc");
                    slider_5_desc = c.getString("img_5_desc");
