...
import com.naxa.nepal.sudurpaschimanchal.activities.AddYourBusinessActivity;
...
import com.naxa.nepal.sudurpaschimanchal.activities.RajnitikAwasthaActivity;
...
public class HomeFragment extends Fragment {
    ...
    public void onResume() {
       ...
       // if (setData) {
        //    ((MainActivity) getActivity()).getSupportActionBar().setTitle(title_nepali);
        //    ((MainActivity) getActivity()).getToolbar().setBackgroundResource(R.color.colorPrimary);

       // }else{
         //   ((MainActivity) getActivity()).getSupportActionBar().setTitle(title_english);
         //   ((MainActivity) getActivity()).getToolbar().setBackgroundResource(R.color.colorPrimary);
